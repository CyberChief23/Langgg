...
func (f *userFunction) name() string {
	...
	return fmt.Sprintf("<fc %s>", f.Name)
}
...
var builtins = map[string]builtinFunction{
	...
	"type":   {typeFc, "type"},
	"upper":  {upperFc, "upper"},
	"colorFc": {colorFc, "colorFc"},
}

func appendFc(interp *interpreter, pos Position, args []Value) Value {
	if len(args) < 1 {
...
func argsFc(interp *interpreter, pos Position, args []Value) Value {
	ensureNumArgs(pos, "args", args, 0)
	return stringsToList(interp.args)
}

func charFc(interp *interpreter, pos Position, args []Value) Value {
...
func exitFc(interp *interpreter, pos Position, args []Value) Value {
	if len(args) > 1 {
...
func findFc(interp *interpreter, pos Position, args []Value) Value {
...
func intFc(interp *interpreter, pos Position, args []Value) Value {
...
func joinFc(interp *interpreter, pos Position, args []Value) Value {
...
func lenFc(interp *interpreter, pos Position, args []Value) Value {
...
func lowerFc(interp *interpreter, pos Position, args []Value) Value {
...
func printFc(interp *interpreter, pos Position, args []Value) Value {
...
func rangeFc(interp *interpreter, pos Position, args []Value) Value {
...
func readFc(interp *interpreter, pos Position, args []Value) Value {
	if len(args) > 1 {
...
func runeFc(interp *interpreter, pos Position, args []Value) Value {
...
func sliceFc(interp *interpreter, pos Position, args []Value) Value {
...
func sortFc(interp *interpreter, pos Position, args []Value) Value {
...
func splitFc(interp *interpreter, pos Position, args []Value) Value {
	if len(args) != 1 && len(args) != 2 {
...
func strFc(interp *interpreter, pos Position, args []Value) Value {
...
func typeFc(interp *interpreter, pos Position, args []Value) Value {
	ensureNumArgs(pos, "type", args, 1)
	return Value(typeName(args[0]))
}

func upperFc(interp *interpreter, pos Position, args []Value) Value {
...
func (f builtinFunction) call(interp *interpreter, pos Position, args []Value) Value {
    if f.Name == "colorFc" {
        return colorFc(interp, pos, args)
    }
    interp.stats.BuiltinCalls++
    return f.Function(interp, pos, args)
}
